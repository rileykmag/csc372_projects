...
$db       = 'rileymag_swic';    // Name of the database
$port     = '3306';                           // Port is usually 3306 in Hostgator
$charset  = 'utf8mb4';                       // UTF-8 encoding using 4 bytes of data per char

$username = 'rileymag_swicAdmin';     // Enter YOUR cPanel username and user here
$password = 'dOnfer2020';           // Enter YOUR user password here                                     
